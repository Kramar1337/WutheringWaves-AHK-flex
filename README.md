...
Первое нажатие открывает карту, если карты нет то запускает браузер по умолчанию и карту прописанную в настройках "data\Config.ini" параметр "MapRunUrl". Имена окон на которые скрипт будет фокусировать свое внимание прописывать в "data\GroupNameMap.txt"
...
T - Спам паутинки. Спамит кнопку "T". В "data\Config.ini" параметр "PautinkaDelayIn" регулирет задержку срабатывания.
